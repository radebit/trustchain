...
//        }
        ...
        try {
            ...
            sysUserService.addUserWithRole(user, "1374681372676894722");//默认临时角色 student
            sysUserService.addUserWithDepart(user, DeptEnum.STUDENT.getDeptId());
            result.success("注册成功");
        } catch (Exception e) {
    ...
    @ApiOperation(value = "移动端修改用户信息", notes = "移动端修改用户信息")
